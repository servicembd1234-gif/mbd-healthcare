      ...
      <section id="products" className="bg-slate-50">
        <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
          <div className="h-60 rounded-2xl p-8 bg-[url('/untitled-design.svg')] bg-cover bg-center bg-no-repeat">
            <Breadcrumbs />
            <h2 className="text-2xl md:text-4xl font-bold">All Medical Equipment</h2>
          </div>

          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-end">
            <div className="flex w-full sm:w-auto items-center gap-2">
              {/* มือถือ: ข้อความสั้น / เดสก์ท็อป: ข้อความยาว */}
              <Input
                type="text"
              ...
              <Input
                type="text"
                placeholder="Search equipments (name / category / partner)"
                className="hidden md:block md:w-120"
                value={q}
                onChange={(e) => setQ(e.target.value)}
              />
