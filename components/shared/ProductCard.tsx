...
function ProductCard({ p }: { p: Product }) {
  ...
  return (
    <div className="relative flex flex-col overflow-hidden rounded-2xl bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-[0_8px_25px_rgba(65,178,253,.2)]">
      {p.badge === "bestseller" && (
      ...
      <div className="flex flex-1 flex-col p-5">
        ...
        <p className="mt-2 text-sm text-slate-600 line-clamp-3 min-h-[3.75rem]">{p.desc}</p>
